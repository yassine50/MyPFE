...
class _GoogleNavBarState extends State<GoogleNavBar> {
  ...
  Widget build(BuildContext context) {
    final List<Widget> screens = widget.renter
        ? [HomeScreen(), Saved(), MyBookingRenter(), InboxWidget(), Setting()]
        : [Dashbord(), MyListing(), MyBooking(), InboxWidget(), Setting()];
    return Scaffold(
          ...
          child: Padding(
            ...
            child: GNav(
              ...
              tabs: widget.renter
                  ...
                  : [
                      GButton(icon: Icons.dashboard_outlined, text: 'Dashbord'),
