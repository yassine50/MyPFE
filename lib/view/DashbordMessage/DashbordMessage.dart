...
import 'package:pfe/view/Chat/Chat.dart';
...
class _InboxScreenState extends State<InboxWidget> {
  final List<Message> messages = [
    Message(
      ...
      message: 'Is the wifi strong enough for video calls? I work remotely so...',
      time: '10:45 AM',
      avatarUrl: 'https://lh3.googleusercontent.com/aida-public/AB6AXuApnjkM38ENrveUa-85f0cipgcdJ4AKmLbi7RK_7byERx8yMHRDTJiux-G0AXbE-hy0rKYhkdA2gz9L8xvwNcwMaAnPACmSEalrBqF9RbfPmHDb2oSQ986JLssg-4J0IIRLHCAPP13L78fAtnyh2cfSTr9JJ6TCSGtL8N9vW8jxhJCoCChZHa4DUkz3K52wZUOPKnAXPxhBl8MPzOpWkDXl6b3jH_OYpVx54Mm7TUqMETDY6DLlJHblT44fkTE0s-eF_fJ1jpPsLqA',
      propertyImageUrl: 'https://lh3.googleusercontent.com/aida-public/AB6AXuAnNzpLgi4eHTHBNKA9agslX7Ojuf-tmj0l6tf0W1n9YvvOvUH2OJxwDq9vRXf1q-9OpupQAxiPT0MBoFjQu5hmOY2a6L_fgU3lUuXuNyZJBZBcpetWFKtXMdh6IzXIF86KGw8qqt_dy4z7wdYyn_7wrpFwuo5wLledDqdJeb1NycJQeSGqlJXQ3iJZZjLPpKSyQ1AYBrihCME8jBjXMtRJJ74D5d0FMyRJkoiu3E2uMMq__TOdGgbmGQJq2TeNit8Q9quOIKwZrSQ',
      isUnread: true,
    ),
    Message(
      name: 'Maria Ionescu',
      ...
      propertyImageUrl: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBVQJ8znKUsb5vG5S53w3ijsyDbymAxq4HwGvMtId2JDNBVLAPlom00r8m10v_oAo8GfG5FQyhx3EVgI2MSZFHwe7ZZqZ459whbWU9w3HMA7Q7n9d4M8Xm2XXBNTT_X-QBboDaGdhdM1oYNU1Xac7UtmyAHlb874UO83_EJWCsizv2zUiyPbqftSzZhj1f-vyT3ojgbf8TNIMapxMvRVXhdtDtYjwH1MeH2wdmIVhMr8GvE6Ru-hd-KbsNPASkRg--DR5wN0z-o9aM',
    ),
    Message(
      name: 'Rental Support',
    ...
    Message(
      ...
      time: 'Oct 10',
      avatarUrl: 'https://lh3.googleusercontent.com/aida-public/AB6AXuD8USW0R0xD-uy9zKMiuHOcYyrfPs8i6p-PJtsYvC3v9daldAnxm8Z2k8Bl1HLqEht5NRmiLYFriMy4kdr_VPyGfteLjFkHILUoJ8L56VqqNzLmmpiFMMiLhQE2V_fRju_L6JjuA_RMgfKbAlEj5rGelX9g-8EBvxQihMMDZ8plnJBewwrJmYs7mDgcn31UYjFhRTZYheE5TM9o22cujOMeJGwgknIOpz5F84OuaTP6lJKDg3q5WMF98BPnsIBWRj4kdPLY4NHPgTQ',
      propertyImageUrl: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBf7s5ufGIbo0nD7c6CQHpQCkV76tV4arFhvI2p8Cw8B-hyTuNOLbg8ed478JrIcNHIXQS7eBDQ0ZrBBuFYTmwbJ_Xd0ETZUEpLYt7i1BiUKEOL3iUCw0rTlughFb_p40oUmdXF_XW91Kb4BRK3jhDUSIfhptkZ4ubwfEtMMNsxftqoPJ2_2FsAD8Whb2SZSgHYAW-aFy6_1uE-6H6ZSHJ6_LoTL5ZLsCgaiIgnOzxGm7h_9MXk4ZRKmpYlUNEkDp4qgY6jUbab2pk',
    ),
    Message(
      name: 'Elena Dobre',
      ...
      time: 'Sep 28',
      avatarUrl: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBvMit0cf__95wNrO1gjFLQX_2_mCEaAVkGKORj9gxJmI7869imayvAPz1EXilSa0zhc9INpYsm_qjV6kEPCZl61EPzfmI5nVUlV_4wmIaVmJ8xLsDr9bqw3T52cBb8Gqj56rOZaxvMqL2L0750bhuWu0fP8PFtp2ez506SwP4YdLmnNZcWOjcB1tD7XuRPhWFaCzkY-xz-Wx6kUjFj13pBkJHQw90F1t-OgDfB2bU4mZc1ufhXVegvibYTGOGqC_L-a_VQ0tGMRXU',
      propertyImageUrl: '',
      isPastGuest: true,
    ),
  ];
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Icon(Icons.signal_cellular_alt, size: 18, color: isDark ? Colors.white : Colors.black),
                        const SizedBox(width: 4),
                        Icon(Icons.wifi, size: 18, color: isDark ? Colors.white : Colors.black),
                        const SizedBox(width: 4),
                        Icon(Icons.battery_full, size: 18, color: isDark ? Colors.white : Colors.black),
                      ],
                    ),
                  ],
                ),
    ...
    itemBuilder: (context, index) {
      return Padding(
        ...
        child: ChoiceChip(
              ...
              Text(
                ...
                style: TextStyle(
                  ...
                  color: selectedFilter == index
                      ? (isDark ? const Color(0xFF136DEC) : Colors.white)
          ...
          backgroundColor: isDark ? const Color(0xFF1E293B) : const Color(0xFFF1F5F9),
          selectedColor: isDark ? Colors.white : const Color(0xFF136DEC),
          shape: RoundedRectangleBorder(
            borderRadius: BorderRadius.circular(20),
          ),
        ),
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemCount: messages.length + 1, // +1 for the "all caught up" message
                  itemBuilder: (context, index) {
    ...
    return Container(
      decoration: BoxDecoration(
        color: message.isSupport
            ? (isDark ? const Color(0xFF1E293B).withOpacity(0.3) : const Color(0xFFF1F5F9).withOpacity(0.5))
            : Colors.transparent,
        border: Border(
          bottom: BorderSide(
                ...
                Padding(
                  ...
                  child: Stack(
                    children: [
                      ...
                      if (message.propertyImageUrl.isNotEmpty && !message.isSupport)
                        Positioned(
                          right: -4,
                          bottom: -4,
                          child: Container(
