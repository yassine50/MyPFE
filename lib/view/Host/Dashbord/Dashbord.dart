...
class _HostDashboardPageState extends State<Dashbord> {
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    ...
                    _buildPerformanceOverview(colors),
                    
                    // Quick Actions
                    _buildQuickActions(colors),
                    
                    // Active Reservations Section
                    _buildActiveReservations(colors),
                    
                    // Recent Messages Preview
                    _buildRecentMessages(colors),
  ...
  // Performance Overview Section
  Widget _buildPerformanceOverview(Map<String, Color> colors) {
    return Padding(
  ...
  // Quick Actions
  Widget _buildQuickActions(Map<String, Color> colors) {
    return Padding(
      padding: const EdgeInsets.fromLTRB(16, 24, 16, 8),
      child: Column(
        children: [
  ...
  // Active Reservations Section
  Widget _buildActiveReservations(Map<String, Color> colors) {
    return Padding(
      padding: const EdgeInsets.fromLTRB(16, 24, 16, 8),
      child: Column(
        children: [
          ...
          Column(
            children: [
              for (var reservation in _activeReservations)
                _buildReservationItem(reservation, colors),
            ],
          ),
        ],
      ),
  ...
  Widget _buildReservationItem(Map<String, dynamic> reservation, Map<String, Color> colors) {
    return Container(
  ...
  Widget _buildRecentMessages(Map<String, Color> colors) {
    return Padding(
      padding: const EdgeInsets.fromLTRB(16, 24, 16, 8),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
  ...
  // Show Notifications
  void _showNotifications(Map<String, Color> colors) {
  ...
  // Create New Listing
  void _createNewListing(Map<String, Color> colors) {
  ...
  // Sync Calendar
  void _syncCalendar(Map<String, Color> colors) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
  ...
  // View All Reservations
  void _viewAllReservations(Map<String, Color> colors) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
