...
class _MyBookingsPageState extends State<MyBookingRenter> {
  ...
  // Segmented Buttons
  Widget _buildSegmentedButtons(Map<String, Color> colors) {
  ...
  // Booking Card
  Widget _buildBookingCard(Map<String, dynamic> booking, Map<String, Color> colors) {
    return Container(
              ...
              children: [
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: IconButton(
                      onPressed: () {
                        _showBookingOptions(booking, colors);
                      },
                      ...
                      child: SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                            backgroundColor: booking['primaryButtonAction'] == 'message'
                                ? colors['primary']
                                : colors['buttonBackground'],
                            foregroundColor: booking['primaryButtonAction'] == 'message'
                                ? Colors.white
                                : colors['textMain'],
  ...
  // Show Booking History
  void _showBookingHistory(Map<String, Color> colors) {
  ...
  void _showBookingOptions(Map<String, dynamic> booking, Map<String, Color> colors) {
    showModalBottomSheet(
      context: context,
      backgroundColor: colors['card'],
      shape: const RoundedRectangleBorder(
  ...
  Map<String, Color> _getColors(bool isDarkMode) {
    if (isDarkMode) {
      return {
        ...
        'segmentBackground': const Color(0xFF334155),
        'buttonBackground': const Color(0xFF334155),
      };
    } else {
      return {
        'primary': const Color(0xFF136DEC),
        ...
        'segmentBackground': const Color(0xFFF1F5F9),
        'buttonBackground': const Color(0xFFF1F5F9),
      };
    }
  }
}